      ...
      const html = `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #111827; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
          ...
          <div style="padding: 32px; background-color: white;">
            ...
            <p>Tuributsa abanyamuryango bose ko amafaranga <strong>500 FRW ku munyeshuri</strong> na <strong>1000 FRW ku warangije kwiga</strong> (minimum) ya buri kwezi atangwa na buri munyanuryango kugira ngo akoreshwe mu murimo mugari dufite w'ivugabutumwa.</p>
